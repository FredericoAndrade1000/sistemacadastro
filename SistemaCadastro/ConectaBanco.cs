...
namespace SistemaCadastro
{
    ...
    {
        MySqlConnection conexao = new MySqlConnection("server=localhost;user id=root;password=;database=si-banco-frederico");
        ...
        {
            MySqlCommand cmd = new MySqlCommand("proc_adicionarBanda", conexao);
            cmd.CommandType = CommandType.StoredProcedure;
